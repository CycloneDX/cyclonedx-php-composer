...
namespace CycloneDX\Tests\unit\Core\Models\License;
...
/**
 * @covers \CycloneDX\Core\Models\License\DisjunctiveLicense
 */
class DisjunctiveLicenseTest extends TestCase
{
    public function testCreateWithIdAndGetId(): void
    {
        $spdxLicenseValidator = $this->createStub(LicenseValidator::class);
